...
VITE_DEV_MODE = getattr(settings, "GRAPHICS_STAFF_VITE_DEV_MODE", False)

VITE_SERVER_PROTOCOL = getattr(settings, "GRAPHICS_STAFF_VITE_SERVER_PROTOCOL", "http")
VITE_SERVER_HOST = getattr(settings, "GRAPHICS_STAFF_VITE_SERVER_HOST", "localhost")
VITE_SERVER_PORT = getattr(settings, "GRAPHICS_STAFF_VITE_SERVER_PORT", 3000)

# These settings match what's in Vite's build.outDir config
APP_STATIC_DIR = "graphics_staff"
VITE_OUT_DIR = "vite"
